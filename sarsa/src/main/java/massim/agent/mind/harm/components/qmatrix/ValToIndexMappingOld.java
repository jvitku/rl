 ...
 *
 */
public class ValToIndexMappingOld {
...
//	public HashMap <String, Integer> map;
	...
	public ValToIndexMappingOld(String varName){
	...
	public ValToIndexMappingOld(String varName, String initVal){
		this.varName = varName;
	...
	public ValToIndexMappingOld(String varName, String[] initVals){
		this.varName = varName;
	...
	public ValToIndexMappingOld(String varName, ArrayList initVals){
		this.varName = varName;
...
//			out = out +" "+map.get(key)
	...
	public synchronized int size(){ return this.maxIndex; }
